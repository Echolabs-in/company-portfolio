...
function BookStrategy() {
  ...
  const handleNext = (e) => {
    ...
    document.querySelector('.strategy-form')?.scrollIntoView({ behavior: 'smooth', block: 'start' })
  }
  ...
  return (
    <div className="App">
      <Header />
      <div className="book-strategy-page">
        <div className="strategy-container">
          <span className="strategy-tag">Book Your Strategy Session</span>
          <h1 className="strategy-main-title">Where Ideas Become Memorable Websites.</h1>
          <div className="strategy-content">
            <div className="strategy-expectations">
            ...
            <form className="strategy-form" onSubmit={handleSubmit}>
              <div className="sales-team-placeholder">
                <img src="/images/sales-team-logo.png" alt="Sales Team" className="sales-team-logo" />
              </div>
      ...
      <div className="book-strategy-faq-wrapper">
        <FAQSection />
      </div>
      <Footer />
    </div>
