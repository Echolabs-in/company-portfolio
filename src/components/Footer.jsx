      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-column">
            <h3 className="footer-heading">Website Services</h3>
            <ul className="footer-links">
              <li><a href="#website-redesign">Website Redesign</a></li>
              <li><a href="#web-development">Web Development</a></li>
              <li><a href="#website-support">Website Support</a></li>
          ...
          <div className="footer-column">
            <h3 className="footer-heading">Website Platforms</h3>
            <ul className="footer-links">
            ...
            <ul className="footer-links">
              <li><a href="#instant-estimate">Instant Website Estimate</a></li>
              <li><a href="#improvement-plan">Website Improvement Plan</a></li>
              <li><a href="#redesign-plan">Website Redesign Plan</a></li>
              <li><a href="#marketing-quiz">Marketing Archetype Quiz</a></li>
              <li><a href="#newsletter">Website Rocket Newsletter</a></li>
              <li><a href="#design-guide">Services Page Design Guide</a></li>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#near-me">Web Design Company Near Me</a></li>
            </ul>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-social">
            ...
            <a href="#twitter" className="social-icon" aria-label="X (Twitter)">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
